...
Module FilterModule1
    ...
    Public Function BA_AddRasFilter(ByVal infilepath As String, ByVal infile As String, _
                ...
                ByVal snapRasterPath As String, ByVal nbrWd As Integer, ByVal nbrHt As Integer, _
                ByVal filterType As esriGeoAnalysisStatisticsEnum, _
                ByVal iterations As Integer, ByVal aoiPath As String, _
                ByVal maskFolder As String, ByVal maskFile As String) As BA_ReturnCode
        ...
        Try
            ...
            Dim aoiClip As AOIClipFile = BA_GetAoiClipFile(maskFile)
            If aoiClip <> AOIClipFile.Missing Then
                retVal = BA_ClipAOIRaster(aoiPath, infilepath + infile, clipRasterName, _
                                          outfilepath, AOIClipFile.AOIExtentCoverage, True)
            Else
                MessageBox.Show("The mask boundary could not be located. The raster filter has failed.", "Error", MessageBoxButtons.OK)
